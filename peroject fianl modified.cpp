...
int main() 
{
              ...
              string accountNumber ,password , newpassword , changedpassword;
             double amount ;
            int numAccounts = 0;
            int choice;
...
while (true) 
 {    
        ...
        cout << "   2 . To  Perform Deposit\n";
        cout << "   3 . To Perform  withdraw  \n";
            ...
            if (numAccounts >= MAX_ACCOUNTS)
             ...
             else 
             {
               ...
               cout <<" enter your  age : ";
                ...
                cout << " ✅️. Account created successfully!\n";
                numAccounts++;
            }
         }
                         ...
                         if (accounts[accountIndex].password == password) 
                               {
                                  ...
                                  cin >> amount;
                                    ...
                                    cout << "✅️.  Deposit successful!\n";
                              }
                         else
                             {
                                  cout<<" ⚠️  incorrrect password\a"<<endl;
                            }
                    }
               else
                       {
                           cout << "⚠️ Account not found\a\n";
                           break;
                       }
              } 
                           ...
                           if (accounts[accountIndex].password == password) 
                                 {
                                    ...
                                    if (amount <= accounts[accountIndex].balance)
                                           {
                                               accounts[accountIndex].balance -= amount;
                                              cout << "✅️. Withdrawal successful!\n";
                                          }  
                                  else 
                                         {
                                              cout << " ⚠️. Insufficient balance for withdrawal.\n\a";
                                        }
                                 }
                          else
                                {
                                     ...
                                     if( accounts[accountIndex].password == changedpassword)    
                                           {
                                               ...
                                               cout << "✅️.  password changed successful!\n";
                                           }
                                    else
                                        {    
                                             accounts[accountIndex].password = password ;
                                             cout<<" ⚠️ you entered two different new passwords\a"<<endl;
                                        }
                                }
                  }        
               else
